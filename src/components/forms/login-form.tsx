...
export function LoginForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  const handleSocialLogin = async (provider: string) => {
    try {
      ...
      const token = await result.user.getIdToken(); // Pega o token do Firebase
      ...
      console.log("Usuário salvo no MongoDB:", data.user);
      toast({ title: "Success", description: `Login com ${provider} bem-sucedido!`, variant: "success" });
      router.push("/");
    } catch (error) {
      console.error("Erro no login social", error);
      toast({ title: "Erro", description: "Falha ao autenticar com " + provider, variant: "destructive" });
    }
  };
          ...
          <form onSubmit={onSubmit} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground">Inicie sessão na sua conta A-Aprender</p>
              </div>
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <a href="/auth/recovery" className="ml-auto text-sm underline-offset-2 hover:underline">
                ...
                className={isPasswordValid ? 'border-green-500 focus-visible:ring-green-500' : password ? 'border-red-500 focus-visible:ring-red-500' : ''}
                required
              />
              ...
              <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
                ...
                >
                  ...
                  <span className="sr-only">Iniciar sessão com a Apple</span>
                </Button>
                <Button
                  type="button"
                ...
                >
                  ...
                  <span className="sr-only">Iniciar sessão com o Google</span>
                </Button>
                <Button
                  type="button"
                ...
                >
                  ...
                  <span className="sr-only">Iniciar sessão com a Meta</span>
                </Button>
              </div>
